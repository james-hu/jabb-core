...
public class BackoffStrategiesTest {
    ...
    public int failedAttempt(long attemptNumber, long delaySinceFirstAttempt) {
    	return (int)attemptNumber;
    }

    public int failedRetryAfterAttempt(long attemptNumber, long delaySinceFirstAttempt) {
    	return (int)attemptNumber;
    }
