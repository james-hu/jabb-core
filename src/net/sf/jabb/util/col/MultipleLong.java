 ...
 *
 */
public class MultipleLong implements Comparable<Object>, Serializable{
	 ...
	 * @param values	一批长整型值
	 */
	public MultipleLong(long... values){
		this.values = values;
	}
